...
# ── 6. Build and start ───────────────────────────────────────────────────────
echo ""
info "Building and starting backend + frontend (this may take a few minutes on first run)..."
echo ""
docker compose up --build -d

echo ""
ok "========================================"
ok "  S&P 500 Analytics is starting up!"
ok "========================================"
echo ""
...
echo ""
echo "  Note: The first start seeds the database (~619k rows)."
echo "        The frontend will be ready in ~30-60 seconds."
echo ""
